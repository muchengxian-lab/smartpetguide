# Backlink Outreach Round 3 — Guest Post Targets

> 目标：5 个接受宠物类 Guest Post 的网站，用 SmartPetGuide 原创内容换取 dofollow 外链。
> 策略：每个网站提 1 个具体选题（已有的强内容，稍作改写投递），而非泛泛问"能投稿吗"。
> 人工作业：Claude Code 准备选题+邮件，人类发送。

## Target List

| # | Site | URL | Signal | Pitch Topic |
|:--:|------|------|------|------|
...
## Guest Post Pitches (D0 Email)

> 发件：press@smartpetguide.net
> 每封邮件包含具体选题 + 1 个已发布样本链接。不要群发，逐封发送，间隔 30 分钟。

### 1. PetPlace.com

**To:** Find via petplace.com/write-for-us
**Subject:** Guest post pitch: Robot vs Stick Vacuum for Pet Hair (research-backed)

```
Hi PetPlace editors,

I run SmartPetGuide, an independent research site where we analyze verified owner reviews and product data to help pet owners make smarter purchases. I'd like to pitch a guest post for PetPlace.

Proposed topic: "Robot Vacuum vs Stick Vacuum for Pet Hair — What 50+ Owners Actually Say (2026)"

The article compares the two vacuum types specifically for pet owners, covering:
- Why robot vacuums win on hard floors (daily automated cleaning)
- Why stick vacuums win on carpet (5-10x more suction)
- The optimal daily/weekly combo setup
- Budget picks starting at $179

The angle is research-backed — I've analyzed hundreds of verified Amazon reviews from pet owners, plus manufacturer specs and marketplace data. No affiliate links, no product placements. Pure information for pet owners deciding where to spend $179-699.

Sample of my writing: https://smartpetguide.net/guides/robot-vacuum-vs-stick-vacuum-pet-hair/
...
**To:** Find via entirelypets.com/guest-blogger.html
**Subject:** Guest post pitch: Are Automatic Feeders Worth It for One Cat?

```
Hi EntirelyPets team,

I run SmartPetGuide, a research-backed pet device review site. I saw you're accepting guest bloggers and would love to contribute.

Proposed topic: "Are Automatic Feeders Worth It for One Cat? Honest Research From 8,700+ Verified Owner Reviews"

Most feeder guides assume multiple pets. This piece focuses specifically on single-cat homes:
- When an $89 feeder pays for itself (2 weekend trips = $150 saved on pet sitter)
- When manual feeding is perfectly fine (consistent WFH schedule, wet-food-only cats)
- The cost-benefit math: WOPET $89 vs Petlibro $139 vs PETKIT $129

No brand sponsorships, no affiliate bias. Just honest data from verified purchases.

Sample: https://smartpetguide.net/guides/are-automatic-feeders-worth-it-for-one-cat/
...
**To:** Find via yourvetonline.com/write-for-us/
**Subject:** Guest post pitch: Stainless Steel vs Plastic Fountains — 18,500 Owner Reviews

```
Hi Your Vet Online team,

I run SmartPetGuide, an independent pet product research site. I saw you welcome pet owner insights and would like to pitch a contribution.

Proposed topic: "Stainless Steel vs Plastic Cat Fountains — What 18,500 Verified Owner Reviews Actually Reveal"

The piece covers:
- Why cats prefer steel (plastic biofilm is the #1 fountain complaint)
- Cat acne and fountain material — what vets say
- 3 budget stainless options from $39
- How to transition a cat from plastic to steel

Written in an accessible, research-backed style — no brand deals, no affiliate bias. I think Your Vet Online readers would find this genuinely useful.

Sample of my research approach: https://smartpetguide.net/guides/stainless-steel-vs-plastic-fountains/
...
**To:** Find via lenoxvet.com/pages/new-affiliate
**Subject:** Guest post pitch: First Smart Pet Device — Research-Backed Starter Guide

```
Hi LenoxVet team,

I run SmartPetGuide, a research-backed site covering smart pet devices. I'd love to write a guest post for LenoxVet.

Proposed topic: "How to Choose Your First Smart Pet Device — A Research-Backed Guide for New Owners"

Rather than pushing specific products, this guide helps owners figure out which device actually solves their problem:
- Scooping fatigue → self-cleaning litter box
- Worried pet isn't eating → automatic feeder with camera
- Cat barely drinks → water fountain
- Dog escapes yard → GPS tracker

Based on verified Amazon review patterns across 26 devices. No affiliate links, no brand bias.

Sample: https://smartpetguide.net/guides/first-smart-pet-device-guide/
...
- D0: 7/7（实际发送 3/5；#1/#2 未找到公开编辑邮箱）
- D3 (7/10): 跟进未回复的目标（无回复）
- D7 (7/14): 状态更新如下
...
### #3 Pretty Happy Pets — 回复摘要（2026-07-14）

- 证据状态：人工确认已收到接受回复；未在公开仓库保存私人邮件原文。
